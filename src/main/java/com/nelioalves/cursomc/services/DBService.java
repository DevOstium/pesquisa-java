...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "lirafagner@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("fagner"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "fagnerlira@hotmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("fagner"));
